...
def layout_for_logged_in_users(username):
    ...
    st.write("""
    Churn Insight is a Machine Learning application that predicts the likelihood of an employee to leave the company based on various demographic and job-related factors.
